...
catPred <- apply(numU, 1, FUN=Euclid, nms=nms, k=k) # Apply to rows of unknown to get a vector of predicted categories
return(catPred)
}
...
library(caret)
(cM <- confusionMatrix(predTest,glassTest$Type))
...
```
The lowest k-value of 5 has the best accuracy with ~81%.
</p>
