...
<p class='a'>
Decision trees and RIPPER are adapted for situations where the decision making process must be transparent. RIPPER will re-evaluate cuts where a decision tree will not, which can add to computational load. Neither algorithm is particularly suited or data that has the majority of attributes as numeric.
</p>
